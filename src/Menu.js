...
const Menu = ({
  ...
  const dialogMessages = [
    "Classic. Get to the goal with all the cheese.",
  ...
  const aboutMessage = (
    <div>
      ...
      <br />
      <br />
      Follow the adventurous journey of a clever rat navigating intricate mazes, 
      driven by the irresistible quest for cheese treasures 
      hidden amidst the labyrinthine paths
    </div>
  );
  ...
  return (
    <Grid>
      ...
      <Grid item>
  <Button
    onClick={() => handleOpen(aboutMessage)}
    className={classes.button}
    size="large"
  >
    About
